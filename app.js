...
function loadExitPage() {
    return `<p>You scored ${answeredCorrect} out of ${myQuestions.length}.</p><br><p>You have successfully completed the quiz , you can click the Restart button below if you'd like to try again. Best of luck and remember you are a Rock Star!Thank you</p><br>
